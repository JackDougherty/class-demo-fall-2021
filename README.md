# Class Demo Fall 2021
using Leaflet maps with a linked Google Sheets template or CSV files and GeoJSON data on GitHub

## Live links (replace with your own)
- Leaflet Map https://jackdougherty.github.io/class-demo-fall-2021/
- Google Sheets template https://docs.google.com/spreadsheets/d/1UME7k80nSbER_PZLW74MWhrbEhwPcDRZkRvcq-BBAoI/edit#gid=0
